...
using JuanBackFinal.ViewModels.Account;
...
namespace JuanBackFinal.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(RoleManager<IdentityRole> roleManager, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, JuanAppDbContext context)
        {
        ...
        //    await _roleManager.CreateAsync(new IdentityRole { Name = "Publisher" });
